 ...
 */
final class Version20231012164829 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE resource (id INT AUTO_INCREMENT NOT NULL, rarity_id INT NOT NULL, name VARCHAR(255) NOT NULL, level INT NOT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_BC91F416F3747573 (rarity_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
